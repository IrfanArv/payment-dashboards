        ...
        var f = {
                ...
                if (n) {
                    ...
                    if (i) {
                        var o = function (e, t, n, i) {
                            ...
                            r =
                                this.getLayoutMenu().querySelector(
                                    ".menu-inner"
                                );
                        if (
                            ("string" == typeof i &&
            ...
            scrollPageTo: function (e) {
                ...
                "string" == typeof e && (e = document.querySelector(e)),
                    "number" != typeof e &&
                        (e = e.getBoundingClientRect().top + i.scrollTop);
                var o = i.scrollTop,
                    r = e - o,
                    s = +new Date(),
                    a = function a() {
            ...
            setNavbarFixed: function () {
                var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                        ? arguments[0]
                        : d("fixed");
                this[e ? "_addClass" : "_removeClass"]("layout-navbar-fixed"),
                    this.update();
            },
            setFooterFixed: function () {
                var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                        ? arguments[0]
                        : d("fixed");
                this[e ? "_addClass" : "_removeClass"]("layout-footer-fixed"),
                    this.update();
            },
            setFlipped: function () {
                var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                        ? arguments[0]
                        : d("reversed");
                this[e ? "_addClass" : "_removeClass"]("layout-menu-flipped");
            },
            update: function () {
            ...
            off: function () {
                ...
                (l = l.join(".") || null),
                    this._listeners
                        .filter(function (e) {
                            return e.event === s && e.namespace === l;
                        })
                        .forEach(function (t) {
